...
function useBreakpoint(refreshOnChange = true, defaultScreens = {}) {
  const screensRef = (0, import_react10.useRef)(defaultScreens);
...
var DescriptionsContext = import_react11.default.createContext({});
...
function useItems(screens, items, children) {
  const mergedItems = React21.useMemo(() => (
    // Take `items` first or convert `children` into items
    items || transChildren2Items(children)
  ), [items, children]);
  const responsiveItems = React21.useMemo(() => mergedItems.map((_a) => {
    var {
      span
    } = _a, restItem = __rest3(_a, ["span"]);
    if (span === "filled") {
...
function getCalcRows(rowItems, mergedColumn) {
  ...
  rowItems.filter((n) => n).forEach((rowItem) => {
    const {
      filled
    } = rowItem, restItem = __rest4(rowItem, ["filled"]);
    if (filled) {
...
var useRow = (mergedColumn, items) => {
  const [rows, exceed] = (0, import_react13.useMemo)(() => getCalcRows(items, mergedColumn), [items, mergedColumn]);
  if (true) {
    const warning3 = devUseWarning("Descriptions");
    true ? warning3(!exceed, "usage", "Sum of column `span` in a line not match `column` of Descriptions.") : void 0;
  }
  return rows;
};
...
var Cell = (props) => {
  ...
  const descContext = React22.useContext(DescriptionsContext_default);
  const {
  ...
  if (bordered) {
    return React22.createElement(Component, {
      ...
      style,
      colSpan: span
    }, notEmpty(label) && React22.createElement("span", {
      style: Object.assign(Object.assign({}, labelStyle), styles === null || styles === void 0 ? void 0 : styles.label)
    }, label), notEmpty(content) && React22.createElement("span", {
      style: Object.assign(Object.assign({}, labelStyle), styles === null || styles === void 0 ? void 0 : styles.content)
    }, content));
  }
  return React22.createElement(Component, {
    className: (0, import_classnames.default)(`${itemPrefixCls}-item`, className),
    style,
    colSpan: span
  }, React22.createElement("div", {
    className: `${itemPrefixCls}-item-container`
  }, (label || label === 0) && React22.createElement("span", {
    className: (0, import_classnames.default)(`${itemPrefixCls}-item-label`, descriptionsClassNames === null || descriptionsClassNames === void 0 ? void 0 : descriptionsClassNames.label, {
      [`${itemPrefixCls}-item-no-colon`]: !colon
    }),
    style: Object.assign(Object.assign({}, labelStyle), styles === null || styles === void 0 ? void 0 : styles.label)
  }, label), (content || content === 0) && React22.createElement("span", {
    className: (0, import_classnames.default)(`${itemPrefixCls}-item-content`, descriptionsClassNames === null || descriptionsClassNames === void 0 ? void 0 : descriptionsClassNames.content),
...
function renderCells(items, {
  ...
  return items.map(({
    ...
    if (typeof component === "string") {
      return React23.createElement(Cell_default, {
        key: `${type}-${key || index}`,
        className,
        style,
        styles: {
    ...
    return [React23.createElement(Cell_default, {
      ...
      label,
      type: "label"
    }), React23.createElement(Cell_default, {
...
var Row = (props) => {
  const descContext = React23.useContext(DescriptionsContext_default);
  const {
    prefixCls,
    vertical,
    row,
  ...
  if (vertical) {
    return React23.createElement(React23.Fragment, null, React23.createElement("tr", {
      key: `label-${index}`,
      ...
      type: "label",
      showLabel: true
    }, descContext))), React23.createElement("tr", {
      key: `content-${index}`,
      className: `${prefixCls}-row`
    }, renderCells(row, props, Object.assign({
      component: "td",
  ...
  return React23.createElement("tr", {
    key: index,
    className: `${prefixCls}-row`
  }, renderCells(row, props, Object.assign({
...
var style_default = genStyleHooks("Descriptions", (token2) => {
...
var Descriptions = (props) => {
  const {
    ...
    items,
    classNames: descriptionsClassNames
  } = props, restProps = __rest5(props, ["prefixCls", "title", "extra", "column", "colon", "bordered", "layout", "children", "className", "rootClassName", "style", "size", "labelStyle", "contentStyle", "styles", "items", "classNames"]);
  const {
    getPrefixCls,
    direction,
  ...
  const mergedColumn = React24.useMemo(() => {
    var _a;
  ...
  const contextValue = React24.useMemo(() => ({
    ...
    classNames: {
      label: (0, import_classnames2.default)(contextClassNames.label, descriptionsClassNames === null || descriptionsClassNames === void 0 ? void 0 : descriptionsClassNames.label),
      content: (0, import_classnames2.default)(contextClassNames.content, descriptionsClassNames === null || descriptionsClassNames === void 0 ? void 0 : descriptionsClassNames.content)
    }
  }), [labelStyle, contentStyle, styles, descriptionsClassNames, contextClassNames, contextStyles]);
  return wrapCSSVar(React24.createElement(DescriptionsContext_default.Provider, {
    value: contextValue
  }, React24.createElement("div", Object.assign({
    className: (0, import_classnames2.default)(prefixCls, contextClassName, contextClassNames.root, descriptionsClassNames === null || descriptionsClassNames === void 0 ? void 0 : descriptionsClassNames.root, {
  ...
  }, restProps), (title || extra) && React24.createElement("div", {
    className: (0, import_classnames2.default)(`${prefixCls}-header`, contextClassNames.header, descriptionsClassNames === null || descriptionsClassNames === void 0 ? void 0 : descriptionsClassNames.header),
    style: Object.assign(Object.assign({}, contextStyles.header), styles === null || styles === void 0 ? void 0 : styles.header)
  }, title && React24.createElement("div", {
    className: (0, import_classnames2.default)(`${prefixCls}-title`, contextClassNames.title, descriptionsClassNames === null || descriptionsClassNames === void 0 ? void 0 : descriptionsClassNames.title),
    style: Object.assign(Object.assign({}, contextStyles.title), styles === null || styles === void 0 ? void 0 : styles.title)
  }, title), extra && React24.createElement("div", {
    className: (0, import_classnames2.default)(`${prefixCls}-extra`, contextClassNames.extra, descriptionsClassNames === null || descriptionsClassNames === void 0 ? void 0 : descriptionsClassNames.extra),
    style: Object.assign(Object.assign({}, contextStyles.extra), styles === null || styles === void 0 ? void 0 : styles.extra)
  }, extra)), React24.createElement("div", {
    className: `${prefixCls}-view`
  }, React24.createElement("table", null, React24.createElement("tbody", null, rows.map((row, index) => React24.createElement(Row_default, {
    key: index,
    index,
    colon,
    prefixCls,
...
export {
  ...
  DescriptionsContext_default,
  descriptions_default
};
//# sourceMappingURL=chunk-NVEWLMD2.js.map
